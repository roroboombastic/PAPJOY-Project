window.translations = {
  en: {
    ...
    'info.fastshipping.text': 'Shipping charges based on your items. Transparent GST billing on every order.',
  ...
  es: {
    ...
    'info.fastshipping.text': 'Gastos de envío según tus artículos. Facturación de GST transparente en cada pedido.',
  ...
  fr: {
    ...
    'info.fastshipping.text': 'Frais de livraison selon vos articles. Facturation GST transparente sur chaque commande.',
