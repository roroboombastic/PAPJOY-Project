window.translations = {
  ...
  hi: {
    ...
    'info.fastshipping.text': 'आपके आइटम के आधार पर शिपिंग शुल्क। हर ऑर्डर में सभी कर शामिल हैं।',
  ...
  ar: {
    ...
    'info.fastshipping.text': 'رسوم الشحن بناءً على عناصرك. جميع الأسعار شاملة للضرائب على كل طلب.',
