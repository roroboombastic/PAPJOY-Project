...
const MONGO_URI = process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/papjoy';
...
const products = [
  {
    ...
    tags: ['sneakers', 'running', 'lightweight', 'featured'],
    isFeatured: true,
    isNewArrival: false,
    categorySlug: 'running',
  },
  {
    name: 'Forest Trail Boot',
    slug: 'forest-trail-boot',
    ...
    tags: ['boots', 'waterproof', 'trail', 'featured'],
    isFeatured: true,
    isNewArrival: false,
    categorySlug: 'boots',
  },
  ...
  },
  {
    ...
    tags: ['sneakers', 'lightweight', 'comfort', 'featured', 'new'],
    isFeatured: true,
    isNewArrival: true,
  ...
  },
  {
    ...
    tags: ['running', 'performance', 'carbon', 'featured'],
    isFeatured: true,
    isNewArrival: false,
    categorySlug: 'running',
  },
  {
    ...
    tags: ['sneakers', 'canvas', 'classic', 'new'],
    isFeatured: false,
    isNewArrival: true,
    categorySlug: 'sneakers',
  },
